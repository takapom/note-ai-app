...
- browser deployment embedding adapter 後も残る blocking gap は framework package selection、bundler/app entry wiring、actual deployment config、hosted page から Worker endpoint へ到達する E2E、deployment environment values の管理、build artifact serving path の確定。
